  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{url('funcao/listar')}}">Funcao</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{url('funcionario/listar')}}">Funcionario</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{url('produto/listar')}}">Produto</a>
        </li>
        <li class="nav-item">
